...
const notificationService = new NotificationService(patientRepository, doctorRepository);
const doctorWorkingHoursService = new DoctorWorkingHoursService(doctorRepository);
