...
export const address = new Address("Rua das Flores", "123", "São Paulo", "São Paulo", "11111111");

export const emergencyContact = new EmergencyContact("Maria Silva", "(11) 88888-8888");
...
export const doctor = new Doctor(1, "12345", "Smith", ["Cardiology"], "11987654333");
